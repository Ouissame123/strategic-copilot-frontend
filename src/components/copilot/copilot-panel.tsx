...
export function CopilotPanel() {
    ...
    const showEntityEmpty =
        ...
        ["dashboard", "portfolio", "projects"].includes(pageContext.routeKey) &&
        insights.length === 0 &&
        !loading &&
        !insightsError &&
        !insightsEmpty;
    ...
    return (
        <SlideoutMenu isOpen={isOpen} onOpenChange={setIsOpen} isDismissable>
            {({ close }) => (
                ...
                >
                    <SlideoutMenu.Header onClose={close} className="border-b border-secondary pb-4">
                    ...
                    <SlideoutMenu.Content className="gap-4 pb-8">
