        ...
        <AriaTooltipTrigger {...{ trigger, delay, closeDelay, isDisabled, isOpen, defaultOpen, onOpenChange }}>
            ...
            <AriaTooltip
                ...
                className={({ isEntering, isExiting }) =>
                    cx(
                        isEntering && "ease-in-out animate-in duration-150",
                        isExiting && "ease-in-out animate-out duration-150",
                    )
                }
            >
                {({ isEntering, isExiting }) => (
                    <div
                        className={cx(
                            ...
                            isEntering &&
                                "ease-in-out animate-in fade-in zoom-in-95 duration-150 in-placement-left:slide-in-from-right-0.5 in-placement-right:slide-in-from-left-0.5 in-placement-top:slide-in-from-bottom-0.5 in-placement-bottom:slide-in-from-top-0.5",
                            isExiting &&
                                "ease-in-out animate-out fade-out zoom-out-95 duration-150 in-placement-left:slide-out-to-right-0.5 in-placement-right:slide-out-to-left-0.5 in-placement-top:slide-out-to-bottom-0.5 in-placement-bottom:slide-out-to-top-0.5",
                        )}
                    >
