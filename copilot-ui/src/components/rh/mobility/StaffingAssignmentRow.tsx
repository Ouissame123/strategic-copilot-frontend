...
import { RH_BTN_SECONDARY, RH_TEXT_MUTED, RH_TEXT_PRIMARY, WS_TEXT_FAINT } from "@/utils/rh-workspace-theme";
        ...
        >
            <div className={MOBILITY_ROW_GRID}>
                <div className="min-w-0">
                    ...
                    {jobTitle ? (
                        <p className={cx("mt-0.5 truncate text-xs", RH_TEXT_MUTED)}>{jobTitle}</p>
                    ) : null}
                    {row.talent_email ? (
                    ...
                    {onAssign ? (
                        <button
                            ...
                            className={cx(
                                ...
                                hasManager
                                    ? RH_BTN_SECONDARY
                                    : "border-primary-200/80 text-primary-700 hover:bg-primary-50 dark:border-primary-800 dark:text-primary-200",
                            )}
                        >
