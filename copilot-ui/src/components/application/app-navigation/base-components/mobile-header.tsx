        ...
        <AriaDialogTrigger>
            <header className="flex h-16 items-center gap-3 border-b border-secondary bg-primary py-3 pl-2 pr-4 lg:hidden">
                <AriaButton
                    ...
                    className="group relative flex shrink-0 items-center justify-center rounded-lg bg-primary p-2 text-fg-secondary outline-focus-ring hover:bg-primary_hover hover:text-fg-secondary_hover focus-visible:outline-2 focus-visible:outline-offset-2"
                >
                ...
                <ProjectLogo className="h-8 min-w-0 flex-1" />
            </header>
