...
import type { TalentOpportunitiesDensity } from "./talent-opportunities-ui";

type TalentOpportunitiesDensityToggleProps = {
    density: TalentOpportunitiesDensity;
    onToggle: () => void;
};

export function TalentOpportunitiesDensityToggle({ density, onToggle }: TalentOpportunitiesDensityToggleProps) {
