...
export { TalentSkillsPage } from "./talent/talent-skills-page";
export { TalentTrainingPage } from "./talent/talent-training-page";
export { TalentNotificationsPage } from "./talent/talent-notifications-page";
export { TalentProfileWorkspacePage } from "./talent/talent-profile-workspace-page";
