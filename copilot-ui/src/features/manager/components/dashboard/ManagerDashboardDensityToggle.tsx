...
import type { ManagerDashboardDensity } from "./use-manager-dashboard-density";

type Props = {
    density: ManagerDashboardDensity;
    onToggle: () => void;
};

export function ManagerDashboardDensityToggle({ density, onToggle }: Props) {
